...
function JsHttpRequest() {
  ...
  t.send = function (content) {
    ...
    for (var tryLoader in lds) {
      ...
      if (!ldr) {
        continue;
      } // exclude possibly derived prototype properties from "for .. in".
      ...
      for (var k in content) {
        ...
        if (isFormElement) {
          ...
          if (tn == 'FORM') {
            ...
            if (tn == 'INPUT' || tn == 'TEXTAREA' || tn == 'SELECT' || tn == 'BUTTON') {
...
JsHttpRequest.LOADERS.xml = { loader: function (req) {
  ...
  this.load = function () {
    ...
    if (this.method == 'GET') {
      ...
      if (this.method == 'POST' && !canSetHeaders) {
...
JsHttpRequest.LOADERS.form = { loader: function (req) {
  ...
  this.load = function () {
    ...
    s.innerHTML = (form ? '' : '<form' + (th.method == 'POST' ? ' enctype="multipart/form-data" method="post"' : '') + '></form>') + // stupid IE, MUST use innerHTML assignment :-(
